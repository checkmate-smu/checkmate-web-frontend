    ...
    <main className="mx-auto max-w-7xl px-8 py-16">
      ...
      <section className="mb-32 flex flex-col items-center gap-16 lg:flex-row">
        <div className="flex-1 space-y-8">
          ...
          <h1 className="text-primary font-pretendard text-5xl font-black leading-[1.1] tracking-tighter md:text-7xl">
            뉴스 신뢰도,
            <br />
            CheckMate로
            <br />
          ...
          <p className="text-on-surface-variant font-pretendard max-w-lg text-lg leading-relaxed">
            ...
            <div className="bg-surface-container-lowest border-outline-variant/10 relative flex aspect-square flex-col items-center justify-center rounded-full border p-8 text-center shadow-2xl">
              ...
              <div className="relative mb-6 h-24 w-48">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-end pb-2">
                  ...
                  <span className="text-on-surface-variant font-pretendard text-[10px] font-bold tracking-widest uppercase">
                    Score
                  </span>
                </div>
              </div>
              <h3 className="text-primary font-pretendard mb-2 text-xl font-bold">
                높은 신뢰도
              </h3>
      ...
      <section className="space-y-10">
        <div className="flex items-end justify-between">
          <div>
            <h2 className="text-primary font-pretendard text-3xl font-bold tracking-tight">
              실시간 분석 리포트
            </h2>
            <p className="text-on-surface-variant font-pretendard mt-2 font-medium">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="bg-surface-container-lowest border-outline-variant/10 ambient-shadow group relative flex cursor-pointer flex-col justify-between rounded-full border p-8 md:col-span-2 lg:col-span-2">
            <div className="mb-10 flex items-start justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-secondary font-pretendard text-sm font-bold">
                  VERIFIED
                </span>
              </div>
            ...
            <div className="border-surface-container mt-8 flex items-center justify-between border-t pt-8">
              ...
              <div className="bg-surface-container text-primary font-pretendard rounded-lg px-3 py-1 text-[10px] font-bold tracking-tighter uppercase">
                98% Match
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-container-low flex flex-col rounded-full p-8">
            <div className="mb-8">
              <span className="bg-surface-container-highest text-on-surface-variant font-pretendard mb-4 inline-block rounded-lg px-3 py-1 text-[10px] font-bold">
                MIXED
              </span>
            ...
            <div className="mt-auto">
              <div className="flex items-baseline gap-1">
                ...
                <span className="text-on-surface-variant font-pretendard text-xs font-bold">
                  /100
                </span>
              </div>
